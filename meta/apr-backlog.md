...
### 1. Composition & delegation topology — 💡 Idea (high)

- **One-liner:** Rules for the multi-agent *graph* — when to split an agent vs. add a skill, hub/spoke topology, delegation depth and cycle limits, and the blast radius of composition.
- **Gap:** ASPECT specifies one component; nothing governs how components compose into a system.
- **Relationship:** Extends APR-001 ASPECT from the component to the graph; the strongest remaining *structural* gap. Touches APR-005 (sub-agent output is untrusted input) and APR-003 (routing determinism).

### 2. Pattern mechanism — 💡 Idea (medium)
...
### 3. Artifact lifecycle & model migration — 💡 Idea (medium)
...
### 4. Eval-driven development — 💡 Idea (low / hold)
