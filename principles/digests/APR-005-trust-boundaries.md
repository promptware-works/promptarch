...
> **Generated digest of [APR-005 — A Trust-Boundary and Untrusted-Input Principle for Promptware](../APR-005-trust-boundaries.md) v0.1.0.** The full APR is authoritative — read it for motivation, prior art, and worked detail. Do not edit by hand.
...
---
*Source: [APR-005 — A Trust-Boundary and Untrusted-Input Principle for Promptware](../APR-005-trust-boundaries.md) v0.1.0 · regenerate this digest whenever the source changes.*
