...
> **Generated digest of [APR-013 — An Artifact-Graph Principle for Promptware](../APR-013-artifact-graph.md) v0.2.1.** The full APR is authoritative — read it for motivation, prior art, and worked detail. Do not edit by hand.
...
---
*Source: [APR-013 — An Artifact-Graph Principle for Promptware](../APR-013-artifact-graph.md) v0.2.1 · regenerate this digest whenever the source changes.*
