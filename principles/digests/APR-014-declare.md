...
- **`classification`** — `exec_form: code | prompt` (APR-003) · `skill_kind: capability | pattern` (APR-007) · `trust_level` (APR-005) · `agency: leaf | coordinator` (APR-006) · `max_autonomy_level` / `max_blast_radius` (APR-009).
